package com.example.loginhappytraveller.ui.presentation.login
...
fun LoginScreen(navController: NavHostController, viewModel: LoginViewModel = hiltViewModel()) {
   ...
   // contenido y logo
    Column(
       ...
       // Logo happytraveller
        Image(painter = painterResource(id = R.drawable.logo), contentDescription = "Login image happytraveller",
            modifier = Modifier.size(150.dp))
        Spacer(modifier = Modifier.height(24.dp))

        Text(text = "Inicia con tu cuenta" , fontSize = 20.sp, fontWeight = FontWeight.Bold)
        Spacer(modifier = Modifier.height(24.dp))
