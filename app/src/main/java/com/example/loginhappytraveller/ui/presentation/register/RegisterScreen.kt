package com.example.loginhappytraveller.ui.presentation.register
...
fun RegisterScreen( navController: NavHostController,viewModel: RegisterViewModel = hiltViewModel()) {
    ...
    Column(
        ...
        Image(painter = painterResource(id = R.drawable.logo), contentDescription = "register image happytraveller",
            modifier = Modifier.size(150.dp))
        Spacer(modifier = Modifier.height(28.dp))

        Text(
            modifier = Modifier.fillMaxWidth(),
            text = "Crea una nueva cuenta,ingresa tus datos", textAlign = TextAlign.Center, fontWeight = FontWeight.Bold
        )
